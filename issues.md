...
- [ ] Unstaged: tests/test_web_search_schemas.py — a Python schema-drift guard (Zod vs Pydantic) the tester wrote during /search. Not committed (web task kept web-only). Land separately as `test:` if we want the guard.
